...
import { FaPlay, FaRegThumbsUp, FaThumbsUp, FaVolumeOff, FaVolumeUp } from "react-icons/fa";
        ...
        <ReactPlayer
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-14 ">
            <div className="flex space-x-3">
                <button className="flex items-center gap-x-5 rounded bg-white px-9
                text-x3 font-bold text-black transition hover:bg-[#e6e6e6]">
            ...
            <button className="modalButton" onClick={() => setMuted(!muted)}>
                {muted ? (
            <FaVolumeOff className="h-4.5 w-4.5 bg-[#181818] hover:bg-[#181818]"/> 
            ) : (
            <FaVolumeUp className="h-4.5 w-4.5 bg-[#181818] hover:bg-[#181818]"/>
            )}
            </button>
          </div>
        </div>
        ...
        <div>
            <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
                ...
                <div className="flex flex-col space-y-3 text-sm">
                    ...
                    <div className="text-[gray]">Total votes: </div>
                    {movie?.vote_count}
                </div>
                </div>
            </div>
